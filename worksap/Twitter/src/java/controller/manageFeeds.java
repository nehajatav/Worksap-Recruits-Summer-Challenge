 ...
 * @author jneha
 */
public class manageFeeds extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(submit_action.equals("Delete")){
            model.tweetTable.deleteEntry(request.getParameter("tweetID"));
        } else {
            model.tweetTable.addEntry(request.getParameter("username"),request.getParameter("feed"));
        }
